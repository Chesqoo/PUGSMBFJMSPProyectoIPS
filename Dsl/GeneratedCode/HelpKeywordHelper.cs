...
namespace UPM_IPS.PUGSMBFJMSPProyectoIPS
{
	...
	/// </remarks>
	public partial class PUGSMBFJMSPProyectoIPSHelpKeywordHelper : PUGSMBFJMSPProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected PUGSMBFJMSPProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PUGSMBFJMSPProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static PUGSMBFJMSPProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PUGSMBFJMSPProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected PUGSMBFJMSPProyectoIPSHelpKeywordHelperBase()
			: base() { }

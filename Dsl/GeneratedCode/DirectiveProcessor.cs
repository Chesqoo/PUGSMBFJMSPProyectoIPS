...
namespace UPM_IPS.PUGSMBFJMSPProyectoIPS
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides PUGSMBFJMSPProyectoIPS files
	/// The implementation is done in PUGSMBFJMSPProyectoIPSDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class PUGSMBFJMSPProyectoIPSDirectiveProcessor : PUGSMBFJMSPProyectoIPSDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public PUGSMBFJMSPProyectoIPSDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides PUGSMBFJMSPProyectoIPS files
	/// </summary>
	public class PUGSMBFJMSPProyectoIPSDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string PUGSMBFJMSPProyectoIPSDirectiveProcessorName = "PUGSMBFJMSPProyectoIPSDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "TapizGUIs";
		...
		/// </summary>
		private const string supportedDirectiveName = "PUGSMBFJMSPProyectoIPS";
		...
		/// Constructor
		/// </summary>
		public PUGSMBFJMSPProyectoIPSDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return PUGSMBFJMSPProyectoIPSDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::UPM_IPS.PUGSMBFJMSPProyectoIPS.TapizGUIs));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::UPM_IPS.PUGSMBFJMSPProyectoIPS.TapizGUIs));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "TapizGUIs" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"UPM_IPS.PUGSMBFJMSPProyectoIPS.PUGSMBFJMSPProyectoIPSDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("PUGSMBFJMSPProyectoIPSDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("UPM_IPS.PUGSMBFJMSPProyectoIPS");

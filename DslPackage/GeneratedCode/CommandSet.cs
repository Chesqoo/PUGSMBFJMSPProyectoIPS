...
namespace UPM_IPS.PUGSMBFJMSPProyectoIPS
{
	...
	/// </summary>
	internal partial class PUGSMBFJMSPProyectoIPSCommandSet : PUGSMBFJMSPProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSCommandSet.
		/// </summary>
		public PUGSMBFJMSPProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class PUGSMBFJMSPProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSCommandSetBase.
		/// </summary>
		protected PUGSMBFJMSPProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewPUGSMBFJMSPProyectoIPSExplorerCommand,
				typeof(PUGSMBFJMSPProyectoIPSEditorFactory).GUID);
		...
		{
			PUGSMBFJMSPProyectoIPSExplorerToolWindow explorer = this.PUGSMBFJMSPProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected PUGSMBFJMSPProyectoIPSDocData CurrentPUGSMBFJMSPProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as PUGSMBFJMSPProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected PUGSMBFJMSPProyectoIPSDocView CurrentPUGSMBFJMSPProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as PUGSMBFJMSPProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected PUGSMBFJMSPProyectoIPSExplorerToolWindow PUGSMBFJMSPProyectoIPSExplorerToolWindow
		{
			get
			{
				PUGSMBFJMSPProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(PUGSMBFJMSPProyectoIPSExplorerToolWindow), true) as PUGSMBFJMSPProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				PUGSMBFJMSPProyectoIPSExplorerToolWindow explorerWindow = this.PUGSMBFJMSPProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class PUGSMBFJMSPProyectoIPSClipboardCommandSet : PUGSMBFJMSPProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSClipboardCommandSet.
		/// </summary>
		public PUGSMBFJMSPProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class PUGSMBFJMSPProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected PUGSMBFJMSPProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}

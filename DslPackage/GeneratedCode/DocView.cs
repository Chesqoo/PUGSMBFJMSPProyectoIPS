...
namespace UPM_IPS.PUGSMBFJMSPProyectoIPS
{
	...
	/// </summary>
	internal partial class PUGSMBFJMSPProyectoIPSDocView : PUGSMBFJMSPProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSDocView.
		/// </summary>
		public PUGSMBFJMSPProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class PUGSMBFJMSPProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new PUGSMBFJMSPProyectoIPSDocView.
		/// </summary>
		protected PUGSMBFJMSPProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			PUGSMBFJMSPProyectoIPSDocDataBase docData = this.DocData as PUGSMBFJMSPProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for PUGSMBFJMSPProyectoIPSDocViewBase should be an PUGSMBFJMSPProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.PUGSMBFJMSPProyectoIPS.PUGSMBFJMSPProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.PUGSMBFJMSPProyectoIPS.PUGSMBFJMSPProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.PUGSMBFJMSPProyectoIPS.PUGSMBFJMSPProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.PUGSMBFJMSPProyectoIPS.PUGSMBFJMSPProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.PUGSMBFJMSPProyectoIPSDiagramMenu;
			}
		}
			...
			if(global::UPM_IPS.PUGSMBFJMSPProyectoIPS.PUGSMBFJMSPProyectoIPSHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.PUGSMBFJMSPProyectoIPS.PUGSMBFJMSPProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);

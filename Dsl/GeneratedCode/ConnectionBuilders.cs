...
namespace UPM_IPS.PUGSMBFJMSPProyectoIPS
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)
				{
					if (candidateTarget is global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)
					{
						global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement sourceExampleElement = (global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)candidateSource;
						global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement targetExampleElement = (global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)
				{
					if (target is global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)
					{
						global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement sourceAccepted = (global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)source;
						global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement targetAccepted = (global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElement)target;
						DslModeling::ElementLink result = new global::UPM_IPS.PUGSMBFJMSPProyectoIPS.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
